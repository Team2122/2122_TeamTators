...
public class OperatorInterface extends Subsystem implements Configurable<OperatorInterface.Config>, Supplier<DriveInputSupplier.DriveInput> {
...
//                gunnerSecondary
    ...
    private DriveInputSupplier.DriveInput input = new DriveInputSupplier.DriveInput(0, 0);
    @Override
    public DriveInputSupplier.DriveInput get() { // Returns the value of the gunner joysticks after bring modified by the drive modifiers
...
//        input.set(trigTotal + getDriveRight(), trigTotal + getDriveLeft());
        input.set(getDriveRight(), getDriveLeft());
        return input;
    }
