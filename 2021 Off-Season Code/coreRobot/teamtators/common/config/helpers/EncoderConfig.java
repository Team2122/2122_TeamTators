...
public class EncoderConfig {
    ...
    private double rotationsPerDistance = 1.0;
    ...
    public double getRotationsPerDistance() {
        return rotationsPerDistance;
    }

    public void setRotationsPerDistance(double rotationsPerDistance) {
        this.rotationsPerDistance = rotationsPerDistance;
    }
    ...
    public Encoder create() {
        ...
        encoder.get(); //force initialization
        return encoder;
    }
}
