...
public class TrapezoidalProfileFollower extends AbstractUpdatable implements DataLoggable,
    ...
    private final LogDataProvider logDataProvider = new ControllerLogDataProvider();
    ...
    public synchronized void updateProfile() {
        ...
        if(!baseProfile.validate()) {
            logger.error("One or more required profile parameters is zero!");
        }
    ...
    protected double computeOutput(double delta) {
        ...
        if (calculator.getVelocity() >= config.velocityTolerance) {
    ...
    public static class Config {
        ...
        public double velocityTolerance = 0.001;
    }
