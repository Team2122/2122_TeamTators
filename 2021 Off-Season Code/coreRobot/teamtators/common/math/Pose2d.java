...
public class Pose2d {
    ...
    public edu.wpi.first.wpilibj.geometry.Pose2d toWpiLibPose () {
        return new edu.wpi.first.wpilibj.geometry.Pose2d(this.getTranslation().toWpiLibTranslation(), this.getYaw().toWpiLibRotation());
    }
    public static Pose2d fromWpiLibPose (edu.wpi.first.wpilibj.geometry.Pose2d wpilibPose) {
        return new Pose2d(
                Translation2d.fromWpiLibTranslation(wpilibPose.getTranslation()),
                Rotation.fromWpiLibRotation(wpilibPose.getRotation())
        );
    }
}
