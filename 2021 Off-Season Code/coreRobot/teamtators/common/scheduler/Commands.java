...
public class Commands {
    ...
    public static Command instant(Runnable function) {
        return instant(function, null, EnumSet.of(RobotState.TELEOP, RobotState.AUTONOMOUS));
    }

    public static Command instant(Runnable function, Subsystem requirement, EnumSet<RobotState> validIn) {
        ...
        command.setValidStates(validIn);
        return command;
    }
