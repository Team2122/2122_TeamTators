...
public class DigitalSensorAutoTest extends AutomatedTest implements Configurable<DigitalSensorAutoTest.Config> {
    private Config config;
    private BooleanSupplier digitalSensor;
    private boolean startValue;
    private Timer timer = new Timer();

    public DigitalSensorAutoTest(String name, BooleanSupplier digitalSensor) {
        super(name, true);
