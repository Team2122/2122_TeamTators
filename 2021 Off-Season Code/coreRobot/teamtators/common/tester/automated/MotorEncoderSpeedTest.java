...
public class MotorEncoderSpeedTest extends AutomatedTest implements Configurable<MotorEncoderSpeedTest.Config> {
    ...
    public MotorEncoderSpeedTest(String name, DoubleConsumer motor, DoubleSupplier encoder, Runnable before, double waitBefore) {
        super(name);
        this.motor = motor;
    ...
    public MotorEncoderSpeedTest(String name, DoubleConsumer motor, DoubleSupplier encoder) {
