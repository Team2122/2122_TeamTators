...
public class TatorADXRS450 extends GyroBase implements Gyro, Sendable, AutoCloseable {
    public static final Logger logger = LoggerFactory.getLogger(TatorADXRS450.class);
     ...
     */
    public TatorADXRS450(SPI.Port port) {
        m_spi = new SPI(port);
    ...
    public double getAngle() {
        ...
        return m_spi.getAccumulatorIntegratedValue() * kDegreePerSecondPerLSB + offset;
    }
