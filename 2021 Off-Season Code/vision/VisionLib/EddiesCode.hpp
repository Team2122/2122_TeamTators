...
#define _EDDIES_CODE_
	...
	int NewOptimizedProcessWriteEnhancedSelection(Image_Store* image, Image_Store* scaled, double scale_factor, double threshold, TargetColor color, BoundingBox_VM* box, std::vector<cv::Point>* pointList, TargetLocation* location, std::string* string);
