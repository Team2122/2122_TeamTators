...
public class FullJSONSimulator {
    ...
    FullJSONSimulator(String... autoPaths) throws IOException {
        ...
        for (String auto : autoPaths) {
            SingleAuto singleAuto = JSONAutoParser.generateAutoFromJSON(auto);
    ...
    public void sim(String autoName, double scalePerTick, double timePerTick) throws Exception {
        ...
        while (!KeyBoardListener.get(KeyEvent.VK_X)) {
//            System.out.println(KeyBoardListener.get(KeyEvent.VK_SPACE));
...
//            System.out.println(KeyBoardListener.get(KeyEvent.VK_SPACE));
    ...
    public static void main(String[] args) throws Exception {
        FullJSONSimulator fullJSONSimulator = new FullJSONSimulator(
                "/home/ibrahim/robotics/TatorEyes2/AutoFollower/src/SplineGenerator/Follower/sim/figure_eight.txt"
        ,"/home/ibrahim/robotics/TatorEyes2/AutoFollower/src/SplineGenerator/Follower/sim/blab.txt",
                "/home/ibrahim/robotics/TatorEyes2/AutoFollower/src/SplineGenerator/Follower/sim/blob.txt");
