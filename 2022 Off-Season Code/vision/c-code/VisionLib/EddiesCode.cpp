...
int NewOptimizedProcessWriteEnhancedSelection(Image_Store* image, Image_Store* scaled, double scale_factor, double threshold, TargetColor color, BoundingBox* box, std::vector<Point>* pointList, TargetLocation* location, std::string* string) {
