...
ConnComponents::ConnComponents(Vision_Pipeline* vision_pipeline_data, N_TYPE connectivity, SEGMENTATION_METHOD seg_method )
{
...
int ConnComponents::vision_max_i(int a, int b) { return a > b ? a : b; }
int ConnComponents::vision_min_i(int a, int b) { return a < b ? a : b; }

double ConnComponents::vision_max_d(double a, double b) { return a < b ? b : a; }
double ConnComponents::vision_min_d(double a, double b) { return a < b ? a : b; }
...
int ConnComponents::ccomp_Jacob()
{
	...
	unique_segments = apply_image_LUT( &lookup );
...
int ConnComponents::ccomp_Mark()
{
	...
	unique_segments = trace_CC_Mark( &remapArrayLUT, ccomp_label );
