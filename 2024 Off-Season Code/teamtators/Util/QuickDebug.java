...
public final class QuickDebug {
    ...
    public static <T extends Enum<T>> T input(String name, /*Class<T> enumType, */ T defaultValue) {
        ...
        if (!subtable.containsKey(".enumname") || !subtable.getEntry(".enumname").getString("").equals(enumType.getName())) {
            ...
            subtable.getEntry("options").setStringArray(EnumUtils.enum2nameslist(enumType).toArray(new String[]{}));
            return defaultValue;
        }
