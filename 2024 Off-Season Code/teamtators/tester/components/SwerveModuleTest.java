...
public class SwerveModuleTest extends ManualTest {
    ...
    public SwerveModuleTest(String name, TalonFX drive, TalonFX azimuth, double driveConversion, double rotationConversion) {
		this(name, drive, azimuth, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, driveConversion, rotationConversion);
    }

    public SwerveModuleTest(String name, TalonFX drive, TalonFX azimuth, double speedLimit,
                            double rotationLimit, double driveConversion, double rotationConversion) {
        super(name);
        this.drive = drive;
