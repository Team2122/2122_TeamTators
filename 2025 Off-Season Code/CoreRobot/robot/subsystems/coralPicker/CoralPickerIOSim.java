...
public class CoralPickerIOSim implements CoralPickerIO {
    ...
    public CoralPickerIOSim() {
        ...
        armSim =
                new SingleJointedArmSim(
                        ...
                        armLengthMeters,
                        0,
                        Math.PI / 2, // max angle (rad) (90 deg)
                        true,
                        0);
    }
    ...
    public void updateInputs(CoralPickerIOInputs inputs) {
        ...
        inputs.inductanceSensor = inductanceSensorSim;
    }
}
